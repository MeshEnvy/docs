...
docs/
 ├── Meshtastic_Devices/            
 │    └── <ManufactureName>_<DeviceName>_<VersonNumber> ##LILYGO_T-Beam_SUPREME_V3.0
 |          ├── README.md                               ##Device Info
 │          └── <Relevent Documents>
 |
 ├── Other_Devices/            
 │    └── <ManufactureName>_<DeviceName>_<VersonNumber> ##Waveshare_SIM7070G
 |          ├── README.md                               ##Device Info
 │          └── <Relevent Documents>
 │ 
 ├── Documents/            
 │    └── <ManufactureName>_<DeviceName>_<VersonNumber> ##Folder Template 
 |          └── README.md                               ##Device Info Template 
 │
 ├── RULES.md                  
 └── README.md              
```
